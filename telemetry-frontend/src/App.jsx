...
function App() {
  ...
  const fetchMessages = async () => {
    try {
      const response = await axios.get('https://webprog-it-242-nest-js-tumaliwan.vercel.app/api/pitwall');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('https://webprog-it-242-nest-js-tumaliwan.vercel.app/api/pitwall', { driverName, message });
      setDriverName('');
      setMessage('');
